                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="text-align: -webkit-center;margin-top: 20px;">
                                                                                        <span>
                                                                                            <a href="https://dkpm.com/sjgfW6qC03?tGjsGRc7ge='.$access_token.'" target="_blank" style="background-color: #973c35;text-decoration: none;color: #fff;padding: 10px;font-size: 23px;border-radius: 7px;">Reset Password</a>
                                                                                        </span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        ...
                                                                        <table style="margin-top:50px;">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="margin-top: 20px;">
                                                                                        <span>
                                                                                            <a href="https://dkpm.com/sjgfW6qC03?tGjsGRc7ge='.$access_token.'" target="_blank">https://dkpm.com/sjgfW6qC03?tGjsGRc7ge='.$access_token.'</a>
                                                                                        </span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
